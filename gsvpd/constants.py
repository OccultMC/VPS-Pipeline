...
# Dimension lookup by X tile count alone (zoom 3+).
# Used when Y rows are skipped for tile optimization — x counts are globally unique.
X_COUNT_TO_SIZE = {
    8:  (4096, 2048),   # z3 new
    7:  (3328, 1664),   # z3 old
    16: (8192, 4096),   # z4 new
    13: (6656, 3328),   # z4 old
    32: (16384, 8192),  # z5 new
    26: (13312, 6656),  # z5 old
}

# Possible panorama heights per zoom level (new, old)
ZOOM_HEIGHTS = {
    0: (256, 208),
    1: (512, 416),
    2: (1024, 832),
