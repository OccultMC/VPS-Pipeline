...
# even after retries. Caller (process_panoid) treats this as fatal for the pano
# rather than silently stitching with a hole.
BLACK_TILE = object()
...
async def fetch_tile(
    ...
    after retries, returns the BLACK_TILE sentinel so the caller can abort
    the whole panorama instead of silently stitching with a hole.
    """
    url = (
